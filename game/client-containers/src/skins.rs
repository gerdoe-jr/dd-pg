    ...
    fn load(
        ...
        match files {
            ...
            ContainerLoadedItem::SingleFile(file) => {
                ...
                let converted =
                    client_extra::skin_split::split_06_skin(img.data, img.width, img.height)?;
                ...
                let mut insert_part =
                    |name: &str, part: Skin06Part, copy_right: bool| -> anyhow::Result<()> {
                        ...
                        if copy_right {
                            files.insert(
                                format!("{}.png", name.replace("left", "right")).into(),
                                file.clone(),
                            );
                        }
                ...
                insert_part("eyes_left/surprise", converted.eye_surprise, true)?;
