    ...
    db.setup(
        ...
        vec![
            (
                1,
                vec![
                    setup_race_v1.0.unique_id,
                    setup_teamrace_v1.0.unique_id,
                    setup_maps_v1.0.unique_id,
                    setup_saves_v1.0.unique_id,
                    setup_points_v1.0.unique_id,
                ],
            ),
            (
                2,
                vec![setup_race_v2.0.unique_id, setup_teamrace_v2.0.unique_id],
            ),
        ]
        .into_iter()
        .collect(),
