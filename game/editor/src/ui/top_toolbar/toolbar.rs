                        ...
                        if main_frame_only {
                            ...
                            ui.horizontal(|ui| {
                                ...
                                if ui
                                    ...
                                    .on_hover_ui(|ui| {
                                        let mut cache = egui_commonmark::CommonMarkCache::default();
                                        egui_commonmark::CommonMarkViewer::new("add-quad-tooltip")
                                            .show(ui, &mut cache, TEXT_TILE_BRUSH);
                                    })
                                    .clicked()
                                {}
                            });
                        ...
                        if main_frame_only {
                            ...
                            ui.horizontal(|ui| {
                                ...
                                if ui
                                    ...
                                    .on_hover_ui(|ui| {
                                        let mut cache = egui_commonmark::CommonMarkCache::default();
                                        egui_commonmark::CommonMarkViewer::new("add-sound-tooltip")
                                            .show(ui, &mut cache, TEXT_TILE_BRUSH);
                                    })
                                    .clicked()
                                {}
