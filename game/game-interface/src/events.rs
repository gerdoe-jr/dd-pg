...
pub enum GameWorldEntityEvent {
    Character { ev: GameCharacterEvent },
    Grenade { ev: GameGrenadeEvent },
    Laser { ev: GameLaserEvent },
    Shotgun { ev: GameShotgunEvent },
    Flag { ev: GameFlagEvent },
    Pickup { ev: GamePickupEvent },
}
