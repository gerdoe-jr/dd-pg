...
/// - Passing it inside an URL without escape characters.
/// - Not having contain escape characters, to prevent fatal errors while
///     working with those strings.
/// - Not allowing characters like `-` or upper case prevent confusables aswell as
///     having to deal with case sensitivity.
...
impl ReducedAsciiString {
    ...
    /// This method automatically replaces confusable characters with
    /// proper alternatives, e.g. `-` gets `_`, and also converts disallowed
