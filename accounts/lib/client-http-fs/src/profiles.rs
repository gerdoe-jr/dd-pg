    ...
    > Profiles<C, F>
{
    ...
    pub async fn account_steam_token(
        ...
        account_client::account_token::account_token_steam(
            steam_ticket,
            op,
            secret_key_hex,
            account_client.as_ref(),
    ...
    async fn login_impl(
            ...
            self.take_accountless_keys().await
        {
            ...
            account_client::login::login(credential_auth_token_hex, account_client.as_ref()).await?
        };
    ...
    pub async fn logout(&self, profile_name: &str) -> anyhow::Result<()> {
        ...
        account_client::logout::logout(&*account_client).await?;
    ...
    pub async fn logout_all(
        ...
        Ok(account_client::logout_all::logout_all(account_token_hex, &*account_client).await?)
    }
    ...
    pub async fn delete(
        ...
        account_client::delete::delete(account_token_hex, &*account_client).await?;
        Self::remove_profile(self.profiles.clone(), &self.fs, profile_name).await
    }
    ...
    pub async fn link_credential(
        ...
        Ok(account_client::link_credential::link_credential(
            account_token_hex,
            credential_auth_token_hex,
            &*account_client,
        )
    ...
    pub async fn unlink_credential(
        ...
        Ok(account_client::unlink_credential::unlink_credential(
            credential_auth_token_hex,
            &*account_client,
        )
        .await?)
    ...
    pub async fn account_info(&self, profile_name: &str) -> anyhow::Result<AccountInfoResponse> {
        ...
        Ok(account_client::account_info::account_info(&*account_client).await?)
    }
